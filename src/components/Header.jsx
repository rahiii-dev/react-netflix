...
const Header = () => {
  ...
  return (
    <header className="w-screen h-svh relative overflow-hidden bg-gradient-to-r from-black">
      ...
      <div className="pt-20 container text-white">
        <div className="max-w-xl">
          ...
          <div>
            <button className="px-6 py-2 bg-gray-400 bg-opacity-30 me-3 rounded">
              Play
            </button>
            <button className="px-6 py-2 bg-gray-400 bg-opacity-30 rounded">
              More Info
            </button>
          </div>
        </div>
      </div>
      <div className="absolute top-0 -z-10 bg-slate-950 w-screen h-svh">
        {trailer && 
            <iframe
